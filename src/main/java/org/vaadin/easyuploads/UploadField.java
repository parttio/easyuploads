      ...
      FinishedListener, ProgressListener
{
   ...
   /**
    * @return the string representing the file. The default implementation shows
    *         name, size and first characters of the file if in UTF8 mode.
    */
    ...
    * mark is shown for a empty required field. This faults to "". Even in those
    * cases isValid() returns false for empty required fields.
    * 
    ...
    * 
    * <p>
    * If the datasource has any validators, the same validators are added to the
    * field. Because the default behavior of the field is to allow invalid
   ...
   public void setPropertyDataSource(Property newDataSource)
   {
      ...
      if (dataSource != null
	    && Property.ValueChangeNotifier.class.isAssignableFrom(dataSource
		  .getClass()))
      {
