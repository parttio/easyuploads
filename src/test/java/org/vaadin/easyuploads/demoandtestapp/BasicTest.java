...
public class BasicTest extends AbstractTest
{
   ...
   Component getTestComponent()
   {
	 ...
	 public File createFile(String fileName, String mimeType)
	 {
      ...
      uploadFieldHtml5Configured
	    .setCaption("Storagemode: /Users/Shared/tmp/ , fieldType:"
	 ...
	 public void buttonClick(ClickEvent event)
	 {
      ...
      uploadField4
	    .setCaption("writethrough=false, Storagemode: memory , fieldType:"
		  + uploadField4.getFieldType()+", ValueChangeListener attached");
	       ...
	       long length)
	 {
	    String msg = fileName + " uploaded. Saved to temp file "
		  + file.getAbsolutePath() + " (size " + length + " bytes)";
	 ...
	 protected FileBuffer createReceiver()
	 {
	    ...
	    /*
	     * Make receiver not to delete files after they have been handled by
	     * #handleFile().
	     */
   ...
   class SlowMultiFileUpload extends MultiFileUpload
   {
	 ...
	 return new FileBuffer()
	 {
	    ...
	    {
	       final OutputStream receiveUpload = super.receiveUpload(filename,
		     MIMEType);
